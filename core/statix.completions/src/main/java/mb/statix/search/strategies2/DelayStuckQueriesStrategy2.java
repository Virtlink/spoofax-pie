 ...
 */
public final class DelayStuckQueriesStrategy2 implements Strategy2<SolverState, SolverState, SolverContext> {
    ...
    public List<SolverState> apply(SolverContext ctx, SolverState input) throws InterruptedException {
        ...
        return Collections.singletonList(input.delay(delays.entrySet()));
    }
