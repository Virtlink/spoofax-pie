...
public final class ActionUtils {
     ...
     *                           or {@code null} to position the action at the start or end.
     * @param anchor             The anchor indicating where to position the action;
     *                           or {@code null} to position the action after or at the end.
     */
    public static void addAndRegisterActionGroup(
        AnAction action, String parentID,
        @Nullable String relativeToActionId,
